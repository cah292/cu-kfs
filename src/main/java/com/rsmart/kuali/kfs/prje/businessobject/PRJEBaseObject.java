...
public class PRJEBaseObject
    ...
    private transient Chart baseObjectChart;
    private transient ObjectCodeCurrent baseObjectObjectCodeLow;
    private transient ObjectCodeCurrent baseObjectObjectCodeHigh;
