...
public class PRJEAccountLine
    ...
    private transient Chart accountLineChart;
    private transient Account accountLineAccount;
    private transient ObjectCode accountLineObjectCode;
    private transient SubAccount accountLineSubAccount;
