...
public class PRJEBaseAccount 
    ...
    private transient Chart baseAccountFromChart;
    private transient Chart baseAccountBaseChart;
    private transient Account baseAccountFromAccount;
    private transient Account baseAccountBaseAccount;
    private transient ObjectCodeCurrent baseAccountFromObjectCode;
    private transient SubAccount baseAccountFromSubAccount;
    private transient SubAccount baseAccountBaseSubAccount;
